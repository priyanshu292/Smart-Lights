  ...
  return (
    <div id="products" className="relative bg-gradient-to-r from-blue-200 flex flex-col items-center justify-center px-10 py-[20vh] overflow-hidden lg:px-20 lg:py-[25vh] md:px-14 md:py-[22vh] sm:px-6 sm:py-[18vh]">
      <div className="text-left w-full max-w-5xl mx-auto" {...(window.innerWidth > 1000 ? { "data-aos": "fade-up" } : {})}>
        ...
        <div className="mt-20 grid grid-cols-4 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4" {...(window.innerWidth > 1000 ? { "data-aos": "zoom-in" } : {})}>
        ...
        <div className="relative bg-gradient-to-t from-blue-100 to-white mt-8 flex items-center overflow-hidden flex-col sm:flex-row" {...(window.innerWidth > 1000 ? { "data-aos": "zoom-in" } : {})}>
